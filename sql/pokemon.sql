...
CREATE TABLE `pokemon` (
  ...
  `Defence` varchar(7) DEFAULT NULL,
  `SpecialAttack` varchar(7) DEFAULT NULL,
  `SpecialDefense` varchar(7) DEFAULT NULL,
...
INSERT INTO `pokemon` (`#`, `Name`, `Type1`, `Type2`, `Total`, `HP`, `Attack`, `Defence`, `SpecialAttack`, `SpecialDefense`, `Speed`, `Generation`, `Legendary`) VALUES
